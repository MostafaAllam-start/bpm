...
export function GroupSection({
  ...
  const bgStyle: React.CSSProperties = field.backgroundImage
    ? {
        backgroundImage: `url(${field.backgroundImage})`,
        backgroundRepeat: field.backgroundRepeat ?? "no-repeat",
        backgroundSize: field.backgroundSize ?? "cover",
        backgroundPosition: field.backgroundPosition ?? "center center",
        backgroundAttachment: field.backgroundAttachment ?? "scroll",
        backgroundOrigin: field.backgroundOrigin ?? "padding-box",
        backgroundClip: field.backgroundClip ?? "padding-box",
      }
    : {};
